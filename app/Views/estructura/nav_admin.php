    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="<?= base_url();?>/images/avatar.png" alt="User Image">
        <div>
          <p class="app-sidebar__user-name">Geraldine CN</p>
